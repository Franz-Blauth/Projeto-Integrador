...
function onDeviceReady() {
  db = window.sqlitePlugin.openDatabase({name: 'wolppi.db', location: 'default'}, clearControl);
}
...
window.setInterval("countTime()",11000);
...
//    varifica se o evento ja foi vizualizado

      if (eventS[i].numconfirm == 1){      //    verifica se o evento ja foi vizualizado fica verde ou preto
        tr += '<td colspan="2" style="font-family: "Aaargh", sans-serif; font-variant:small-caps; width:270px; " onClick="callEvent(' + i + ')">' + '<b>' + eventS[i].name  + '</b>' + '</td>';
      }else{
        tr += '<td colspan="2" style="color:#0da205; font-family: "Aaargh", sans-serif; font-variant:small-caps; width:270px; " onClick="callEvent(' + i + ')">' + '<b>' + eventS[i].name + '</b>' + '</td>';
      }
      ...
      tr += '<tr onClick="callEvent(' + i + ')">';
      tr += '<td style="font-family: "Aaargh", sans-serif;" >' + eventS[i].usernickname + '</td>';
      ...
      tr += '</tr>';
      tr += '<tr onClick="callEvent(' + i + ')">';
      tr += '<td style="font-family: "Aaargh", sans-serif; font-size: 90%;" >' + eventS[i].datestart + '&nbsp' + '</td>';
      tr += '<td style="font-family: "Aaargh", sans-serif; font-size: 90%;" >' + eventS[i].timestart + 'H ' + '</td>';
