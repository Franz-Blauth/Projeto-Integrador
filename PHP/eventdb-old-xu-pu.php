...
for($i = 0; $i < $count; $i++){
    ...
    $query="INSERT INTO event(uniqid, name, datestart, timestart, datefinish, timefinish, datelimite, timelimite, local, info, userid, usernickname, datecreate, hourcreate, numinvited, nunconfirm, baseok, eraseok) VALUES('$uniqid', '$name', '$datestart', '$timestart', '$datefinish', '$timefinish', '$datelimite', '$timelimite', '$local', '$info', '$userid', '$usernickname', '$datecreate', '$hourcreate', '$numinvited', '$nunconfirm', '$baseok', '$eraseok')";
